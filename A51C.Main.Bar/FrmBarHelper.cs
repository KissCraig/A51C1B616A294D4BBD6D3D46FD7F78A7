...
namespace A51C.Main.Bar
{
    public class FrmBarHelper
    {
        ...
        public static bool LoadTopFrmBar()
        {
            ...
            {
                // 顶部面板
                PublicStatic.TopPanel = new Control.Fase.LPanel(
            ...
            else
            {
                ...
                PublicStatic.TopPanel = new Control.Fase.LPanel
                (
                    PublicStatic.MainDynamic.Dynamic.MainPanel,
                    0,
                    new System.Drawing.Size(BasePublic.Ui.Width, 50),
                    new System.Drawing.Point(0, 0),
                    System.Drawing.Color.Transparent,
            ...
            PublicStatic.ShowList.ListItemTxts = new List<object>();
            // 后退按钮
            PublicStatic.FrmBack = new Control.Gase.FrmBarBtn(
                fatherPanel,
