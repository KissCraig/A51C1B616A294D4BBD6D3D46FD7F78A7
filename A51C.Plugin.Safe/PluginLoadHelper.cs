...
using A51C.Plugin.Safe.Resx;

namespace A51C.Plugin.Safe
{
    /// <summary>
    ...
    public class PluginLoadHelper
    {
        ...
        /// 插件描述
        /// </summary>
        public string Description = "应用加密";
        ...
        /// 插件唯一标识
        /// </summary>
        public string Guid = "407B7B86-B40A-4A33-9250-215D777A8A71";
        ...
        public bool PluginLoaded()
        {
            ...
            if (PluginBefore())
            {
                try
                {
                    ...
                    PublicStatic.LiuXingPal.BackColor = System.Drawing.Color.DodgerBlue;
                    return true;
                }
