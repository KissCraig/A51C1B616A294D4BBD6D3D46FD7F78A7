                ...
                else
                {
                    ...
                    for (var i = 0; i < smallCount; i++)
                    {
                        ...
                        if (hastitleDesc)
                        {
                            ...
                            {
                                // ReSharper disable ObjectCreationAsStatement
                                new MetroForListItem(this, true, IsCanEdit, false, false, false, IforeColor, IbackColor, FontFamily, TitleDesc, null, ListItemMouseClick)
                                // ReSharper restore ObjectCreationAsStatement
                                {
                            ...
                            else
                            {
                                if (ListItemTxts != null)
                                {
                                    ...
                                    // ReSharper disable ObjectCreationAsStatement
                                    new MetroForListItem(this, false, IsCanEdit, IsButton, IsImage, false, IforeColor, IbackColor, FontFamily, ListItemTxts[i - 1], tip, ListItemMouseClick)
                                    // ReSharper restore ObjectCreationAsStatement
                                    {
                                        Size = new System.Drawing.Size(SmallWidth, SmallHeight),
                        ...
                        else
                        {
                            if (ListItemTxts != null)
                            {
                                ...
                                // ReSharper disable ObjectCreationAsStatement
                                new MetroForListItem(this, false, IsCanEdit, IsButton, IsImage, false, IforeColor, IbackColor, FontFamily, ListItemTxts[i], tip, ListItemMouseClick)
                                // ReSharper restore ObjectCreationAsStatement
                                {
                                    Size = new System.Drawing.Size(SmallWidth, SmallHeight),
                                    Location = new System.Drawing.Point(1, 1 * (i + 1) + SmallHeight * i)
