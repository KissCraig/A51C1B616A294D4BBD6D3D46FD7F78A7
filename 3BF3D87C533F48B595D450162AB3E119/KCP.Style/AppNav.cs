...
namespace App.Style
{
                ...
                case @"NavMax":
                    {
                        ...
                        BasePublic.Ui.SizeChanged += Ui_SizeChanged;
                    }
                    break;
                case @"NaxMin":
                    {
                ...
                case System.Windows.Forms.FormWindowState.Normal:
                    {
                        foreach (
                            var nav in
                                BasePublic.Ui.Controls.OfType<AppNav>()
                                      .SelectMany(
        ...
        private static void Nav_MouseClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            switch (nav.Text)
            {
                ...
                case @"ä":
                    {
                        nav.Text = @"å";
                        BasePublic.Ui.TopMost = false;
                    }
                    break;
                case @"å":
                    {
                        nav.Text = @"ä";
                        BasePublic.Ui.TopMost = true;
                    }
                    break;
                    // NavTray
                case @"æ":
    ...
    public class AppNav : EPanel
    {
        public AppNav(int key, bool isColor)
        {
            ...
            Location = new System.Drawing.Point(BasePublic.Ui.Width - Helper.NavSize.Width * key, 0);
        }
    }
}