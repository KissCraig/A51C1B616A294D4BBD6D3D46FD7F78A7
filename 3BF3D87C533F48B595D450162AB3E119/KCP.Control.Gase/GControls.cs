...
using System.Linq;
namespace KCP.Control.Gase
{
    /// <summary>
    /// Frm.Bar.Btn
    /// </summary>
    public sealed class FrmBarBtn : Base.ELabel
    {
        public FrmBarBtn(
    ...
    public sealed class InputBoxWithDesc : Base.ETextBox
    {
    ...
    public sealed class InputSearch : Base.ETextBox
    {
        private System.Drawing.Color Linecolor { get; set; }
        private System.Drawing.Color Linelight { get; set; }
        private System.Drawing.Color Backcolor { get; set; }
    ...
    public class RadioSigleBox : Base.ECheckBox
    {
        private Fase.HLabel Radiotap { get; set; }
    ...
    public class CheckSingleBox : Base.ECheckBox
    {
        private Fase.HLabel Radiotap { get; set; }
        private bool Single { get; set; }
        private string Group { get; set; }
    ...
    public sealed class CheckMultiBox : Fase.HPanel
    {
        ...
        public void GetThisClear(bool all)
        {
            foreach (
                var m in
                    Controls.OfType<Fase.HPanel>()
                            .SelectMany(
                                t =>
                                (t).Controls.OfType<Fase.LPanel>()
                                   .SelectMany(
                                       k =>
                                       (k).Controls.OfType<Fase.LFlyPal>()
    ...
    public class EnBrowser : System.Windows.Forms.WebBrowser
    {
        ...
        protected override void CreateSink()
        {
            ...
            cookie = new System.Windows.Forms.AxHost.ConnectionPointCookie(ActiveXInstance, events,
