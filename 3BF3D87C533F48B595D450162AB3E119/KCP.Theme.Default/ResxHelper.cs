namespace KCP.Theme.Default
{
    public class ResxHelper
    {
        ...
        public System.Drawing.Image GetImage(string imageResxName)
        {
            ...
            {
                var stream = GetType().Assembly.GetManifestResourceStream("KCP.Theme.Default.Image." + imageResxName);
                if (stream == null)
                {
                    return null;
                }
        ...
        public System.Drawing.Icon GetIco(string icoResxName)
        {
            ...
            using (var stream = GetType().Assembly.GetManifestResourceStream("KCP.Theme.Default.ICO." + icoResxName))
            {
                if (stream == null)
                {
                    return null;
