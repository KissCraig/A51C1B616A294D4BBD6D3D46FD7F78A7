namespace KCP.Control.Fase
{
    /// <summary>
    /// 带4个边的面板
    /// </summary>
    public sealed class FPanel : Base.EPanel
    {
        public FPanel
            (
    ...
    public sealed class FLines : Base.EPanel
    {
        public FLines
            (
            System.Windows.Forms.Control thisFather,
            ...
            )
        {
            ...
            var fatherLine = new Base.ELabel
                {
            ...
            var fatherfather = new Base.EPanel
                {
            ...
            {
                var clickButton = new Base.ELabel
                    {
                ...
                var clickimage = new Base.ELabel
                    {
    ...
    public class HPanel : Base.EPanel
    {
        public HPanel()
        {
            AllowDrop = true;
    ...
    public class HLaple : Base.ELabel
    {
        public HLaple()
        {
            BackColor = System.Drawing.Color.Transparent;
    ...
    public sealed class HDarge : Base.ELabel
    {
        public HDarge
            (
            System.Windows.Forms.Control parentpal,
    ...
    public class HLabel : Base.ELabel
    {
        public HLabel
            (
            System.Windows.Forms.Control parentpal,
    ...
    public class LFlyPal : Base.EFlyPal
    {
        public LFlyPal
            (
            System.Windows.Forms.Control parentpal,
    ...
    public sealed class HPrevImg : Base.EPicBox
    {
        public HPrevImg
            (
            System.Windows.Forms.Control parentpal,
    ...
    public sealed class HDarImg : Base.EPicBox
    {
        public HDarImg
            (
            System.Windows.Forms.Control parentpal,
    ...
    public class HLable : Base.ELabel
    {
        public HLable()
        {
            BackColor = System.Drawing.Color.Transparent;
